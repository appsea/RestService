...
public class Main {
    ...
    private Collection<QuestionBank> buildQuestionBank() {
        ...
        bank.add(new QuestionBank("Base SAS Question.txt",200, 435, 10, 10108, true, true));
        bank.add(new QuestionBank("Advance-sas-questions.txt", 150, 262, 7, 10072, true, true));
        return bank;
    }
